...
mongo-ubuntu:
	cmake -S modules/mongo-cxx-driver -B modules/mongo-cxx-driver/build -DCMAKE_INSTALL_PREFIX="prebuild/mongo-cxx-driver" -DENABLE_BSONCXX_POLY_USE_IMPLS=ON -DBUILD_VERSION="3.10.2" -DCMAKE_CXX_FLAGS_INIT="-fPIC" -DCMAKE_BUILD_TYPE=Release --fresh
